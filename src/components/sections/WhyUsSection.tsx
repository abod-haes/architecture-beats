...
export default function WhyUsSection() {
  ...
  return (
    <section className="site-section section-panel py-16 sm:py-20">
        ...
        >
          {content.whyUs.map((item) => {
            ...
            return (
              ...
              >
                <div className="pointer-events-none absolute -end-10 -top-10 h-28 w-28 border border-brand-primary/25 bg-[var(--site-accent-soft)] transition group-hover:scale-110" />
                <div className="relative mb-4 grid h-11 w-11 place-items-center border border-brand-primary/45 bg-brand-primary/15">
                  <Icon className="h-6 w-6 text-brand-secondary" />
                </div>
                <h3 className="relative mb-2 text-xl font-black text-brand-dark">{item.title}</h3>
