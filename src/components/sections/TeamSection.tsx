      ...
      >
        {teamProfiles[locale].map((member) => {
          ...
          return (
            ...
            >
              <div className="pointer-events-none absolute -end-10 -top-10 h-28 w-28 border border-brand-primary/30 bg-brand-primary/10 transition group-hover:scale-110" />
