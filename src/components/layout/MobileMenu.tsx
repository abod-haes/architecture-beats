        ...
        >
          <nav className="flex flex-col gap-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <button type="button" onClick={onLanguageToggle} className="inline-flex items-center justify-center gap-2 border border-[var(--site-border)] bg-[var(--site-card)] px-3 py-3 font-black text-brand-dark transition hover:border-brand-primary hover:bg-[var(--site-accent-soft)]">
